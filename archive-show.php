    ...
    <div  class="app-main page-width group ">
     ...
     <?php  get_template_part('parts/nav');?>
      ...
      <div class="show-card group padded-section">
        ...
        <div class="pull-left padded-mobile-1 grid-60">
            ...
            <span class="start-playlist"><span data-icon="m"></span>Play show playlist</span>
            <div class="show-description "> <?php my_excerpt(55);?> </div>

        </div>
        </a>

        <div class="grid-20 pull-right show-rollup-sidebar padded-mobile-1">
